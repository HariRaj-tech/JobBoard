        ...
        <nav className="bg-gray-800 ">
            <div className="container mx-auto px-4 flex items-center justify-between py-4 ">
                ...
                <div className="flex items-center space-x-4">
                    <Link to="/companyhomepage" className="text-white text-xl font-bold">JobBoard</Link>
                    <Link to="/companyhomepage" className="text-white text-base hover:text-gray-200">Home</Link>
                    <Link to="/postnewjob" className="text-white text-base hover:text-gray-200">Post New Job</Link>
